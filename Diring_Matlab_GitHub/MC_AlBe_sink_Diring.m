...
load mc_source_Diring.mat                               % Load file with sink simulations
name = 'mc_sink_Diring';                                % Filename for saving
...
R_SLHL = 6.95;                                         % 26Al/10Be production ratio at SLHL
...
parpool;
    ...
    save(name,'NBe_inh_initial','NAl_inh_initial','NBe_post',...
        ...
        'source_pluck','Tice','erate_source','Nt','Ne','elevation_source','ero','-v7.3')
